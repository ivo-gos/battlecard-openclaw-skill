...
- **Start a simulation**: "Start a simulation for Notion vs Confluence" - Practice selling against an AI prospect who uses real competitor data. Free (2 lifetime) or Starter+.
- **Start a voice simulation**: "Start a voice simulation for Notion vs Confluence" - Same as above, but prospect responds with audio. Free (1 lifetime) or Starter+.
